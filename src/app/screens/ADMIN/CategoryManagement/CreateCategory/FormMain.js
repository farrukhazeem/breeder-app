        ...
        <div style={{
            ...
            <Row gutter={30} >
                <Col span={12} style={{ textAlign: "center" }}>
                    <Card onClick={() => props.history.push({pathname: '/admin/category/create', state: {type: 'animal'}})} style={{ padding: 30 }}>
                ...
                <Col span={12} style={{ textAlign: "center" }} className="hover">
                    <Card onClick={() => props.history.push({pathname: '/admin/category/create', state: {type: 'product'}})} style={{ padding: 30 }}>

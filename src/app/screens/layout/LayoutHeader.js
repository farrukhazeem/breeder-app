    ...
    <Layout theme="light" style={{ minHeight: '100vh', background: "white" }}>
      ...
      <Layout className="site-layout" style={{ background: 'white' }}>
        <div style={{ height: 64 }}>
          ...
          <Header className="site-layout-background" style={{ padding: 0, background: 'white', borderLeft: '1px solid #f0f0f0', borderRadius: '50px 0px 0px 0px' }}>
            ...
            <span style={{ float: 'right', marginRight: 30 }}>
              <Dropdown trigger='click' overlay={menu}>
                <Space>
                  ...
                  <span className="fs-120 dropdown-avatar-text" >{userData ? userData.data.name : 'Logly'}</span>
                  <DownOutlined />
                </Space>
              </Dropdown>
            </span>
            {/* <span style={{ float: 'right', marginRight: 30, fontSize: '1.5em' }}>
              <Link to={'/notification'} style={{color: '#001529'}}><ExclamationCircleOutlined style={{fontWeight: 'bold'}} /></Link>
            </span> */}
            <span style={{ float: 'right', marginRight: 30, fontSize: '1.5em' }}>
              <Link to={'/notification'} style={{color: '#001529'}}><BellOutlined style={{fontWeight: 'bold'}} /></Link>
            </span>
          </Header>
        </div>
        <Content

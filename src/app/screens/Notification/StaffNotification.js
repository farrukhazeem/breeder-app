...
const names = ['Staff Notification Total', 'Staff Notification Alive', 'Staff Notification Sick', 'Staff Notification final'];
function StaffNotification({ data, deleteNotificationFunc }) {
    return (
        <>
            {
